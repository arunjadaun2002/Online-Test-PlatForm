...
const TakeTest = () => {
    ...
    const incrementTabSwitchCount = () => {
        ...
        if (newCount === 1) {
            setWarningMessage('Warning: You have switched tabs 1 time. You have 2 attempts remaining.');
            setShowWarning(true);
        } else if (newCount === 2) {
            setWarningMessage('Warning: You have switched tabs 2 times. You have 1 attempt remaining.');
            setShowWarning(true);
        } else if (newCount >= 3) {
            handleSubmitTest();
        }
    ...
    const handleSubmitTest = async () => {
        ...
        try {
            ...
            // Navigate to result page with test ID
    ...
    return (
        <div className="take-test-page">
            ...
            <div className="test-header">
                ...
                <div className="test-info">
                    <div className="timer">
                        ...
                        <span className={`timer-value ${remainingTime <= 300 ? 'warning' : ''}`}>
            ...
            <div className="test-content">
                ...
                <div className={`question-palette ${showQuestionPalette ? 'active' : ''}`}>
                    <button 
