      ...
      <div className="settings-section">
        ...
        <div className="settings-item">
          <svg className="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            ...
            <path d="M12 2C14.5013 4.73835 15.9228 8.29203 16 12C15.9228 15.708 14.5013 19.2616 12 22C9.49872 19.2616 8.07725 15.708 8 12C8.07725 8.29203 9.49872 4.73835 12 2Z" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          <span>Language</span>
        </div>
      ...
      <div className="settings-section">
        ...
        <div className="settings-item">
          <svg className="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            ...
            <path d="M14 11C13.5705 10.4259 13.0226 9.95083 12.3935 9.60707C11.7643 9.26331 11.0685 9.05889 10.3534 9.00768C9.63821 8.95646 8.92041 9.05964 8.24871 9.31023C7.57701 9.56082 6.96691 9.95294 6.46 10.46L3.46 13.46C2.54921 14.403 2.04524 15.666 2.05663 16.977C2.06802 18.288 2.59387 19.5421 3.52091 20.4691C4.44795 21.3961 5.70201 21.922 7.013 21.9334C8.32398 21.9448 9.58699 21.4408 10.53 20.53L12.24 18.82" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
